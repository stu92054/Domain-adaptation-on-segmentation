...
ITER_SIZE = 1
NUM_WORKERS = 4
DATA_DIRECTORY = '../../../VSlab2/nitahaha/re_leftImg8bit512/'
DATA_LIST_PATH = './dataset/cityscapes_list/pretrain.txt'
IGNORE_LABEL = 255
INPUT_SIZE = '1024,512'
DATA_DIRECTORY_TARGET = '../../../VSlab2/nitahaha/re_leftImg8bit512/'
...
def main():
    ...
    if args.model == 'DeepLab':
        ...
        if args.restore_from[:4] == 'http' :
            saved_state_dict = model_zoo.load_url(args.restore_from,map_location="cuda:0")
        else:
            import pdb
    ...
    for i_iter in range(args.num_steps):
        ...
        if i_iter >= args.num_steps_stop - 1:
            print ('save model ...')
            torch.save(model.state_dict(), osp.join(args.snapshot_dir, 'cityscapes_' + str(args.num_steps) + '.pth'))
        ...
        if i_iter % args.save_pred_every == 0 and i_iter != 0:
            ...
            torch.save(model.state_dict(), osp.join(args.snapshot_dir, 'cityscapes_' + str(i_iter) + '.pth'))

...
def per_class_iu(hist):
    return np.diag(hist) / (hist.sum(1) + 1e-8 + hist.sum(0) - np.diag(hist))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--devkit_dir', default='dataset/Synthia_list', help='base directory of cityscapes')

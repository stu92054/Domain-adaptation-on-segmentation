...
def get_src_only_training_parser(parser=None):
    ...
    parser.add_argument('--add_bg_loss', type=bool, default=False,
                        help='consider background loss?') # fix
...
def get_da_base_training_parser(parser=None):
    ...
    parser.add_argument('src_dataset', type=str, choices=["gta", "city", "city16", "synthia"])
    parser.add_argument('tgt_dataset', type=str, choices=["gta", "city", "city16", "synthia", "Taipei", "Tokyo", "Roma", "Rio"])
